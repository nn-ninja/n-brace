...
exports.MySettingManager = void 0;
...
var DisplaySettings_1 = require("@/settings/categories/DisplaySettings");
var DEFAULT_SETTING = {
    savedSettings: [],
    pluginSetting: {
        maxNodeNumber: 200,
        searchEngine: SettingsSchemas_1.SearchEngineType["default"]
    }
};
...
var MySettingManager = /** @class */ (function () {
    ...
    function MySettingManager(plugin) {
        this.setting = new State_1.State(DEFAULT_SETTING);
    ...
    MySettingManager.getNewSetting = function (type) {
        if (type === SettingsSchemas_1.GraphType.global) {
            // @ts-ignore
            return {
                filter: {
                    searchQuery: "",
                ...
                groups: [],
                display: {
                    nodeSize: DisplaySettings_1.nodeSize["default"],
                    linkThickness: DisplaySettings_1.linkThickness["default"],
                    linkDistance: DisplaySettings_1.linkDistance["default"],
                    nodeRepulsion: DisplaySettings_1.nodeRepulsion["default"],
